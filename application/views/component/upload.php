    ...
    <div class="container-fluid">
        ...
        <div class="container my-5">
            <ul id="progressbar" class="text-center">
                ...
                <li class="active" id="step2"><div class="d-none d-md-block">Upload Extract</div></li>
            ...
            <form action="<?php echo base_url('generate/upload')?>" method="POST" enctype="multipart/form-data">
                <input type="text" name="proc_id" value="<?php echo $data['proc_id']?>" hidden>
